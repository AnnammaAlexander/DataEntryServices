...
export function UserNavbar() {
  ...
  const navList = (
    <ul className=" mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 lg:hidden">
      <Typography
        as="li"
        variant="small"
        color="white"
      ...
      >
        ...
        <a href="/conditions" className="flex items-center">
          Terms & Condition{" "}
        </a>
      </Typography>
      ...
      {/* <Typography
        ...
        className="flex items-center gap-x-2 p-1 font-medium"
      >
      <ChatBubbleOvalLeftEllipsisIcon class="h-6 w-6 text-white" />
  ...
  return (
    <Navbar
      className=" max-w-none z-50  rounded-none fixed  border-none"
      // style={{ background: "#17a2b8" }}
      style={{
        backgroundImage:
          "linear-gradient(173.1deg, rgba(226,66,249,0.94) 10.2%, rgba(79,147,249,1) 0%)",
        // backgroundImage: 'radial-gradient(circle farthest-corner at 12.3% 19.3%, rgba(85,88,218,1) 0%, rgba(79,147,249,1) 100.2%)',
      }}
    >
      <div className="flex items-center gap-5 lg:justify-between text-blue-gray-900">
          ...
          <BellAlertIcon class="h-6 w-6 text-white" />
            ...
            {/* <div> */}
            <Chat/>
          {/* <ChatBubbleOvalLeftEllipsisIcon class="h-6 w-6 text-white lg:block hidden" /> */}
          {/* </div> */}
            <h1 className="hidden lg:inline-block text-lg font-bold text-white">
              userName
            </h1>
