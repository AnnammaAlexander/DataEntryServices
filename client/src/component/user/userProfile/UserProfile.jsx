...
import { changeUserMobileNum, getUser } from "../../../API/apiUserConnection";
...
export function UserProfileCard() {
  ...
  const 
  handleNumberChange = () => setPhOpen(!phOpen);
  ...
  return (
    <div className="bg-cyan-50 h-full lg:w-[calc(100vw-17rem)] fixed right-0 w-screen overflow-y-scroll">
      <div className="h-screen">
        ...
        <div className="pt-8  gap-3  flex lg:flex-row flex-col mb-20 items-center">
        {/* <div className="grid lg:grid-cols-2 grid-cols-1 w-fit gap-2 "> */}
          ...
          <Card className="lg:h-96  rounded-none ">
            <Tabs value={activeTab}>
              ...
              >
                <TabPanel value="Overview" className="flex flex-col justify-center items-center ">
        ...
        <Dialog size="xm" open={phOpen} handler={handleNumberChange}>
          <div className="flex flex-col items-center p-4">
            ...
            <form onSubmit={formik2.handleSubmit} className="w-full max-w-sm">
              ...
              />
              <p className="h-4 ml-2 text-sm mb-5 text-red-800">
